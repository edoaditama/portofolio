...
const PROJECTS = [
  {
    ...
    description: "Sistem informasi penjualan berbasis web dengan integrasi pembayaran.",
    tech: [
  ...
  },
  {
    ...
    description: "Aplikasi pengolahan data administrasi untuk efisiensi workflow.",
    tech: [
...
const SOCIAL_LOGOS = [
  { node: <SiGithub size={30} />, title: "GitHub", href: "https://github.com/edoaditama" },
  { node: <SiInstagram size={30} />, title: "Instagram", href: "https://www.instagram.com/edoaditamma/" },
  { node: <SiWhatsapp size={30} />, title: "WhatsApp", href: "https://wa.me/62895619910461" },
];
  ...
  return (
    <main className="relative min-h-screen bg-zinc-950 text-white overflow-x-hidden selection:bg-cyan-400 selection:text-black">
      ...
      >
        ...
        {/* About Card */}
        <div id="about" className="relative z-20 mt-16 md:mt-24 w-full scroll-mt-24">
            ...
            <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-6">
              ...
              <div
                className={`transition-all duration-1000 ease-out transform ${
                  isAboutFinished ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <a
      ...
      {/* 4. Projects Section */}
      <section id="projects" className="relative z-10 py-20 md:py-32 px-6 max-w-6xl mx-auto scroll-mt-20">
      ...
      {/* 5. Contact Section */}
      <section id="contact" className="relative z-10 py-20 md:py-32 px-4 md:px-6 max-w-5xl mx-auto scroll-mt-20">
        <div className="bg-zinc-900/30 border border-cyan-400/50 rounded-[2.5rem] md:rounded-[3.5rem] p-10 md:p-20 backdrop-blur-md shadow-3xl text-center">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="pt-8">
              <LogoLoop logos={SOCIAL_LOGOS} speed={25} fadeOut fadeOutColor="#09090b" />
            </div>
            <div className=" pt-2  text-base md:text-xl text-zinc-200  ">
                <p>
                Email : edoaditama66@gmail.com
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="relative z-10 pb-12 px-6">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="font-bold text-zinc-600 text-[10px] md:text-xs tracking-[0.2em] uppercase text-center">
            &copy; {new Date().getFullYear()} Prameswara Edo Aditama. All rights reserved.
          </p>
        </div>
      </footer>
    </main>
